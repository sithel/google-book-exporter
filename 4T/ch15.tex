...
\hl{}\footnote{\textbf{Suko T }Ooo a battle map!  Pretty sweet. \textsubscript{01/31/13 5:41pm}}\footnote{$\rightarrow$\textbf{Rebecca S. }I like how Lackovich is purple... suggesting half ``good team'', half ``bad team''.  Should we take this as foreshadowing? ;) \textsubscript{02/03/13 12:10am}}\footnote{$\rightarrow$\textbf{Nathaniel Ford }Ahahaha. No comment. \textsubscript{02/07/13 4:45pm}}+1
...
======================
	...
	Unable to highlight for footnote: To be explicitly clear: Jonah has no idea what _actually_ happened there.  He won't even really remember the flash or mention it in all likelihood until after it's over (possibly during debrief)., unable to correctly match (exceeded acceptable limit):ExpectedJonah sees that same purple light flash, and suddenly a figure is there

	Unable to understand footnote +1, too many options & none that matched \footnote{$\rightarrow$\textbf{Nathaniel Ford }It was Darth Plagius \textsubscript{01/31/13 4:19pm}}. Optional comment markups: \footnote{$\rightarrow$\textbf{Suko T }+1 \textsubscript{02/14/13 1:32am}}\footnote{$\rightarrow$\textbf{Suko T }+1 \textsubscript{01/31/13 4:54pm}}\footnote{$\rightarrow$\textbf{Nathaniel Ford }+1 \textsubscript{01/31/13 4:22pm}} 

	Unable to highlight for footnote: He never headed for Jaya, just faced her direction and knelt. because:GivenExpectedOne has a bigger gun and he kneels down, facing in JayaOne has a bigger gun and he starts heading down the street toward Jaya

	Unable to highlight for footnote: technically this happened later but it saves me some typing and make the flow better to put it here, unable to correctly match (exceeded acceptable limit):Expected[Refresh: Senior Constable 2]

	Unable to understand footnote +1, too many options & none that matched \footnote{$\rightarrow$\textbf{Nathaniel Ford }Ahahaha. No comment. \textsubscript{02/07/13 4:45pm}}. Optional comment markups: \footnote{$\rightarrow$\textbf{Suko T }+1 \textsubscript{02/14/13 1:32am}}\footnote{$\rightarrow$\textbf{Suko T }+1 \textsubscript{01/31/13 4:54pm}}\footnote{$\rightarrow$\textbf{Nathaniel Ford }+1 \textsubscript{01/31/13 4:22pm}} 
